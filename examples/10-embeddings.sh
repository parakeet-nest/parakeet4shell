...
#TODO: find several similarities
#TODO: then try: who are Philippe Charriere and Jean-Luc Picard
...
DOCUMENT_CONTENT="<context><doc>${DOCS[${selected_doc_key}]}</doc></context>"
